<div class='container'>
  ...
  //include('../Buttoms/export.php');
  // table-striped
  ?>
  <table class ="table table-bordered table-hover" id = "mydata">
    <thead> <tr> <?php CreateHeader(); ?> </tr> </thead>
    <tbody> <?php
...
$('#mydata').dataTable(
  {
    ...
    "sDom": "t",
    columnDefs: [
      { width: 20,targets: 0 },{ width: 250, targets: 1 },{ width: 50, targets: 2 },
      { width: 50, targets: 3 },  { width: 50, targets: 4 },{ width: 10, targets: 5 },
      { width: 70, targets: 6 },{ width: 70, targets: 7 },  { width: 10, targets: 8 },
      { width: 50, targets: 9 },  { width: 50, targets: 10 },  { width: 50, targets: 11 },
      { width: 20, targets: 12 },{ width: 250, targets: 13 },
    ],
    select: {
      style:    'os',
